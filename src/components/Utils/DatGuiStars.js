...
function DatGuiStars() {
    ...
    useEffect(() => {
        ...
        function jsStarfield() {
            ...
            this.set_amount = function (amount) {
                ...
                if (this.amount < this.stars.length) {
                    ...
                    for (var i = 0; i < amt; i++) this.stars.push(new Vector3(
                        rand_range(
                            -this.canvas.width,
                            this.canvas.width),
                        rand_range(
            ...
            this.init_stars = function () {
                for (var i = 0; i < this.amount; i++) this.stars.push(new Vector3(
                    rand_range(
                        -this.canvas.width,
                        this.canvas.width),
                    rand_range(
        ...
        function _update_(time) {
            const delta_time = (time - starfield.last_frame) * 0.001;
    ...
    return <canvas id="main_canvas"></canvas>;
}

export default DatGuiStars